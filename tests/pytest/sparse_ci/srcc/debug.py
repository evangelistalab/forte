...
def solve_selected_ucc_equations(
    t1,
    op,
    selected_op,
    op_pool,
...
def run_selected_ucc(
    method, max_exc, omega, e_convergence=1.0e-12, compute_threshold=1.0e-15, selection_threshold=1.0e-15
):
    ...
    for macro_iter in range(max_macro_iter):
        ...
        t1, e = solve_selected_ucc_equations(
            t1, op, selected_op, op_pool, denominators, ref, as_ints, compute_threshold, e_convergence
        )
