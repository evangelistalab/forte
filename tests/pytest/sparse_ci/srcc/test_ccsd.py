...
def test_ccsd():
    ...
    ref_energy = -1.126712715716011 # from psi4
    ...
    forte_objs = scc.make_forte_objs(psi4_wfn,mo_spaces={})
    calc_data = scc.run_cc(forte_objs,psi4_wfn,cc_type='cc',max_exc=2,e_convergence=1.0e-11)
