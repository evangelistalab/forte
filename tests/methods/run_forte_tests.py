...
tests = fci_tests + casscf_tests + dsrg_mrpt2_tests + active_dsrgpt2_tests + dsrg_mrpt3_tests + mrdsrg_tests + adaptive_ci_tests + pci_tests + pci_hashvec_tests
tests = dsrg_mrpt2_tests + active_dsrgpt2_tests
