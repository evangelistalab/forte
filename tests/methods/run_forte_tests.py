...
dsrg_mrpt3_tests = ["dsrg-mrpt3-1","dsrg-mrpt3-2","dsrg-mrpt3-3"]
...
tests = fci_tests + casscf_tests + dsrg_mrpt2_tests + dsrg_mrpt3_tests + mrdsrg_tests + adaptive_ci_tests + apifci_tests
maindir = os.getcwd()
if len(sys.argv) == 1:
    cmd = ["which","psi4"]
