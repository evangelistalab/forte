...
//ExplorerIntegrals* SafeString::ints_ = 0;

//SafeString::SafeString(const std::vector<int>& occupation,bool print_det)
...
//SafeString::SafeString(const std::vector<bool>& occupation, bool print_det)
//    : nmo_(occupation.size() / 2)
//{
//    allocate();
//    for(int p = 0; p < nmo_; ++p){
...
//SafeString::SafeString(const SafeString& det)
//    : nmo_(det.nmo_)
//{
//    allocate();
...
//SafeString::SafeString(const SafeString& ref,const ExcitationDeterminant& ex)
//    : nmo_(ref.nmo_)
//{
//    allocate();
//    for (int n = 0; n < 2 * nmo_; ++n){
...
//void SafeString::set_bits(bool *&alfa_bits,bool *&beta_bits)
//{
//    std::copy(alfa_bits,alfa_bits + nmo_,alfa_bits_);
//    std::copy(beta_bits,beta_bits + nmo_,beta_bits_);
//}

//void SafeString::set_bits(std::vector<bool>& alfa_bits,std::vector<bool>& beta_bits)
//{
...
// */
//double SafeString::energy() const
//{
...
// */
//double SafeString::one_electron_energy()
//{
//    double matrix_element = 0.0;
//    for(int p = 0; p < nmo_; ++p){
//        if(alfa_bits_[p]) matrix_element += ints_->diag_roei(p);
...
// * @return the kinetic energy
// */
//double SafeString::kinetic_energy()
//{
//    double matrix_element = 0.0;
//    for(int p = 0; p < nmo_; ++p){
...
// * @return the electronic energy (does not include the nuclear repulsion energy)
// */
//double SafeString::excitation_energy(const SafeString& reference)
//{
//    double matrix_element = 0.0;
...
// * @return the electronic energy (does not include the nuclear repulsion energy)
// */
//double SafeString::excitation_ab_energy(const SafeString& reference)
//{
//    double matrix_element = 0.0;
//    // Find the difference in orbital occupation
//    int naexp = 0;
...
// */
//int SafeString::excitation_level(const SafeString& reference)
//{
//    int nex = 0;
//    for(int p = 0; p < nmo_; ++p){
...
// * @return the relative excitation level
// */
//int SafeString::excitation_level(const bool* Ia,const bool* Ib)
//{
//    int nex = 0;
//    for(int p = 0; p < nmo_; ++p){
...
// * @return
// */
//double SafeString::slater_rules(const SafeString& rhs) const
//{
//    bool* Ia = alfa_bits_;
//    bool* Ib = beta_bits_;
...
// * @return
// */
//double SafeString::SlaterRules(const std::vector<bool>& Ia,const std::vector<bool>& Ib,const std::vector<bool>& Ja,const std::vector<bool>& Jb)
//{
//    double matrix_element = 0.0;
...
// * @return
// */
//double SafeString::Spin2(const std::vector<bool>& Ia,const std::vector<bool>& Ib,const std::vector<bool>& Ja,const std::vector<bool>& Jb)
//{
//    double matrix_element = 0.0;
...
//void SafeString::SlaterOPDM(const std::vector<bool>& Ia,const std::vector<bool>& Ib,const std::vector<bool>& Ja,const std::vector<bool>& Jb,SharedMatrix Da,SharedMatrix Db,double w)
//{
//    double sign = 1.0;
//    int nmo = static_cast<int>(Ia.size());
...
//void SafeString::SlaterdiagOPDM(const std::vector<bool>& Ia,const std::vector<bool>& Ib,std::vector<double>& Da,std::vector<double>& Db,double w)
//{
//    // Case 1: PhiI = PhiJ
//    int nmo = static_cast<int>(Ia.size());
//    for (int n = 0; n < nmo; ++n) {
...
////double SlaterRules(SafeString& PhiI, SafeString& PhiJ,boost::shared_ptr<Integrals>& ints)
////{
////    double matrix_element = 0.0;
...
////double SlaterOPDM(SafeString& PhiI, SafeString& PhiJ,int p,bool spin_p,int q,bool spin_q)
////{
////    double sign = 1.0;
////    bool* Ia = PhiI.get_alfa_bits();
////    bool* Ib = PhiI.get_beta_bits();
...
////double SlaterTPDM(SafeString& PhiI, SafeString& PhiJ,int p,bool spin_p,int q,bool spin_q,int r,bool spin_r,int s,bool spin_s)
////{
////    double sign = 1.0;
////    bool* Ia = PhiI.get_alfa_bits();
////    bool* Ib = PhiI.get_beta_bits();
...
////double Slater3PDM(SafeString& PhiI, SafeString& PhiJ,int p,bool spin_p,int q,bool spin_q,int r,bool spin_r,int s,bool spin_s,int t,bool spin_t,int u,bool spin_u)
////{
////    double sign = 1.0;
////    bool* Ia = PhiI.get_alfa_bits();
////    bool* Ib = PhiI.get_beta_bits();
