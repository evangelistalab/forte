...
void TensorSRG::hermitian_commutator_A_B_C(double factor,
                             BlockedTensor& A1,
                             BlockedTensor& A2,
                             BlockedTensor& B1,
                             BlockedTensor& B2,
...
void TensorSRG::hermitian_commutator_A_B_C_SRC(double factor,
                             BlockedTensor& A1,
                             BlockedTensor& A2,
                             BlockedTensor& B1,
                             BlockedTensor& B2,
...
void TensorSRG::hermitian_commutator_A_B_C_SRC_fourth_order(double factor,
                             BlockedTensor& A1,
                             BlockedTensor& A2,
                             BlockedTensor& B1,
                             BlockedTensor& B2,
...
void TensorSRG::hermitian_commutator_A1_B2_C0(BlockedTensor& A,BlockedTensor& B,double alpha,double& C)
{
}
