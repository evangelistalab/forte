...
class Embedding : public Wavefunction {
  ...
  private:
	...
	double do_env(SharedWavefunction wfn, SharedMatrix h, int methods, Options& options);

	double do_sys(SharedWavefunction wfn, SharedMatrix h, int methods, Options& options);

	std::map<std::string, SharedMatrix> localize(SharedWavefunction wfn, int methods, Options& options);
