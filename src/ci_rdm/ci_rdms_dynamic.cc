        ...
        for( size_t I = first_I; I < last_I; ++I ){
            ...
            for( size_t J = I+1; J < last_I; ++J ){
                ...
                if( ndiff == 2 ){
                    ...
                    double Csq = CI * evecs_->get(b_sorted_string_list_.add(J),root2_);
                    double el = Csq * ui64_slater_sign(Ia,p,q) * 
                                ui64_slater_sign(Ia,r) * ui64_slater_sign(Ja,s,t) *
                                ui64_slater_sign(Ja,u);
            ...
            for( size_t J = I+1; J < last_I; ++J ){
                ...
                if( ndiff == 2 ){
                    ...
                    double el = Csq * ui64_slater_sign(Ib,p,q) * ui64_slater_sign(Ib,r) * 
                                ui64_slater_sign(Jb,s,t) *
                                ui64_slater_sign(Jb,u);
...
outfile->Printf("\n all beta takes %1.6f", bbb.get());
    ...
    //*- Alpha/Beta  -*//
void CI_RDMS::make_ab(SortedStringList_UI64 a_sorted_string_list_, const std::vector<UI64Determinant::bit_t>& sorted_astr,
                ...
                for( size_t I = first_I; I < last_I; ++I ){
                    ...
                    for( size_t J = first_J; J < last_J; ++J ){
                        ...
                        if( nbdiff == 2 ){
                            ...
                            double value = Csq * sign_Ips * ui64_slater_sign(Ib,q,r); // * ui64_slater_sign(Jb,r);
                            ...
                            double value = Csq * sign_IJ * ui64_slater_sign(Ib,q,r) * // ui64_slater_sign(Ib,r) *
                ...
                for( size_t I = first_I; I < last_I; ++I ){
                    ...
                    for( size_t J = first_J; J < last_J; ++J ){
                        ...
                        if( nbdiff == 2 ){
                            ...
                            uint64_t u = lowest_one_idx(Jb_sub);
                            double el = Csq * sign *  
                                        ui64_slater_sign(Ib,r) * ui64_slater_sign(Jb,u);
