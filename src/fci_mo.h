...
using d5 = vector<d4>;
using d6 = vector<d5>;
using vecdet = vector<psi::forte::DynamicBitsetDeterminant>;
...
protected:
    ...
    /// N-Particle Operator
    double OneOP(const DynamicBitsetDeterminant &J, DynamicBitsetDeterminant &Jnew, const size_t &p, const bool &sp, const size_t &q, const bool &sq);
    double TwoOP(const DynamicBitsetDeterminant &J, DynamicBitsetDeterminant &Jnew, const size_t &p, const bool &sp, const size_t &q, const bool &sq, const size_t &r, const bool &sr, const size_t &s, const bool &ss);
    double ThreeOP(const DynamicBitsetDeterminant &J, DynamicBitsetDeterminant &Jnew, const size_t &p, const bool &sp, const size_t &q, const bool &sq, const size_t &r, const bool &sr, const size_t &s, const bool &ss, const size_t &t, const bool &st, const size_t &u, const bool &su);
    ...
    void print_det(const vecdet &dets){
        ...
        for(DynamicBitsetDeterminant x: dets){
            outfile->Printf("  ");
            x.print();
        }
        outfile->Printf("\n");
