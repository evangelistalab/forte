...
#ifndef _adaptive_ci_64_h_
#define _adaptive_ci_64_h_
...
/// Set the ACI options
void set_ACI64_options(ForteOptions& foptions);

/**
 * @brief The AdaptiveCI class
 * This class implements an adaptive CI algorithm
 */
class AdaptiveCI64 : public ActiveSpaceSolver {
  public:
     ...
     */
    AdaptiveCI64(SharedWavefunction ref_wfn, Options& options, std::shared_ptr<ForteIntegrals> ints,
