...
void MASTER_DSRG::set_ambit_MOSpace() {
    ...
    BTF_->add_mo_space(acore_label_, "m, n, m1, n1, m2, n2", core_mos_, AlphaSpin);
    BTF_->add_mo_space(bcore_label_, "M, N, M1, N1, M2, N2", core_mos_, BetaSpin);
    BTF_->add_mo_space(aactv_label_, "u, v, w, x, y, z, u1, v1, w1, z1, x1, y1", actv_mos_, AlphaSpin);
    BTF_->add_mo_space(bactv_label_, "U, V, W, X, Y, Z, U1, V1, W1, Z1, X1, Y1", actv_mos_, BetaSpin);
