...
void DSRG_MRPT2::solve_z() {
    ...
    if (X1_TERM) {
        ...
        b_ck("K") -= 0.5 * temp.block("aa")("zw") * cc1a_n("Kzw"); 
        b_ck("K") -= 0.5 * temp.block("AA")("ZW") * cc1b_n("KZW");
        b_ck("K") -= 0.5 * temp.block("aa")("zw") * cc1a_r("Kzw"); 
        b_ck("K") -= 0.5 * temp.block("AA")("ZW") * cc1b_r("KZW");
        temp.zero();
    }
