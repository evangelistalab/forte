...
class CustomIntegrals : public ForteIntegrals {
  public:
    ...
    void set_tei_from_asints(std::shared_ptr<ActiveSpaceIntegrals> as_ints) override;

    void set_ints_from_asints(std::shared_ptr<ActiveSpaceIntegrals> as_ints) override;
