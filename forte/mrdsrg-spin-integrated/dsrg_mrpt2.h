...
class DSRG_MRPT2 : public MASTER_DSRG {
  ...
  protected:
    ...
    ambit::Tensor cc1a_bra;
    ambit::Tensor cc1a_ket;
    ambit::Tensor cc1b_bra;
    ambit::Tensor cc1b_ket;
    ambit::Tensor cc2aa_bra;
    ambit::Tensor cc2aa_ket;
    ambit::Tensor cc2bb_bra;
    ambit::Tensor cc2bb_ket;
    ambit::Tensor cc2ab_bra;
    ambit::Tensor cc2ab_ket;
    ambit::Tensor cc3aaa_bra;
    ambit::Tensor cc3aaa_ket;
    ambit::Tensor cc3bbb_bra;
    ambit::Tensor cc3bbb_ket;
    ambit::Tensor cc3aab_bra;
    ambit::Tensor cc3aab_ket;
    ambit::Tensor cc3abb_bra;
    ambit::Tensor cc3abb_ket;
