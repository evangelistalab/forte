...
void MASTER_DSRG::set_ambit_MOSpace() {
    ...
    BTF_->add_mo_space(aactv_label_, "u,v,w,x,y,z,u1,w1,z1,x1,y1,1,2,3,a0,a1,a2,a3,a4,a5,a6,a7,a8,a9", actv_mos_,
                       AlphaSpin);
    BTF_->add_mo_space(bactv_label_, "U,V,W,X,Y,Z,U1,W1,Z1,X1,Y1,!,@,#,A0,A1,A2,A3,A4,A5,A6,A7,A8,A9", actv_mos_,
                       BetaSpin);
