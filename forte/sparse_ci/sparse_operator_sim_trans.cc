...
// void sim_trans_antiherm_impl(SparseOperator& O, const SQOperatorString& T_op, sparse_scalar_t
// theta,
//                              double screen_threshold) {
//     // sanity check to make sure all indices are distinct
//     if (T_op.cre().fast_a_xor_b_count(T_op.ann()) == 0) {
...
//         const auto do_sin_theta_half_4 = std::abs(2.0 * sin_theta_half_4 * O_c) >
//         screen_threshold; const auto do_cos_theta_minus_1_2 = std::abs(cos_theta_minus_1_2 * O_c)
//         > screen_threshold;
...
//                                 T.add(TdcOTT_op, -sin_theta_cos_theta_minus_1 * TdcOTT_c *
//                                 TdcOT_c *
//                                                      cOT_c * O_c);
//                             }
...
//                                 T.add(TcOTdT_op, -sin_theta_cos_theta_minus_1 * TcOTdT_c *
//                                 TcOTd_c *
//                                                      cOTd_c * O_c);
//                             }
...
//                                 T.add(TdTOTTd_op, cos_theta_minus_1_2 * TdTOTTd_c * TTd_c *
//                                 TdTO_c *
//                                                       TdT_c * O_c);
//                             }
//                         }
...
//                                 T.add(TTdOTdT_op, cos_theta_minus_1_2 * TTdOTdT_c * TdT_c *
//                                 TTdO_c *
//                                                       TTd_c * O_c);
//                             }
//                         }
...
//                             auto TcOTTd = TcOT_op * Td_op;
//                             for (const auto& [TcOTTd_op, TcOTTd_c] : TcOTTd) {
//                                 T.add(TcOTTd_op, -dsin_theta_cos_theta_minus_1 * TcOTTd_c *
//                                 TcOT_c *
//                                                      cOT_c * O_c);
//                             }
//                         }
...
//                         for (const auto& [TdTOTdT_op, TdTOTdT_c] : TdTOTdT) {
//                             T.add(TdTOTdT_op,
//                                   dcos_theta_minus_1_2 * TdTOTdT_c * TdT_c2 * TdTO_c * TdT_c *
//                                   O_c);
//                         }
//                     }
//                     // + (cos(theta) - 1)^2 T^dagger T O T T^dagger
...
//                         for (const auto& [TdTOTTd_op, TdTOTTd_c] : TdTOTTd) {
//                             T.add(TdTOTTd_op,
//                                   dcos_theta_minus_1_2 * TdTOTTd_c * TTd_c * TdTO_c * TdT_c *
//                                   O_c);
//                         }
//                     }
//                 }
...
//                         for (const auto& [TTdOTdT_op, TTdOTdT_c] : TTdOTdT) {
//                             T.add(TTdOTdT_op,
//                                   dcos_theta_minus_1_2 * TTdOTdT_c * TdT_c * TTdO_c * TTd_c *
//                                   O_c);
//                         }
//                     }
//                     // + (cos(theta) - 1)^2 T T^dagger O T T^dagger
...
//                         for (const auto& [TTdOTTd_op, TTdOTTd_c] : TTdOTTd) {
//                             T.add(TTdOTTd_op,
//                                   dcos_theta_minus_1_2 * TTdOTTd_c * TTd_c2 * TTdO_c * TTd_c *
//                                   O_c);
//                         }
//                     }
//                 }
