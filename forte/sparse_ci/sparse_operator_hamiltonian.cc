...
template SparseOperator sparse_operator_hamiltonian<float>(double, ndarray<float>&, ndarray<float>&,
                                                           ...
                                                           double);
template SparseOperator sparse_operator_hamiltonian<double>(double, ndarray<double>&, ndarray<double>&,
                                                            ndarray<double>&, ndarray<double>&, ndarray<double>&,
                                                            double);
template SparseOperator sparse_operator_hamiltonian<std::complex<float>>(double, ndarray<std::complex<float>>&,
                                                                        ndarray<std::complex<float>>&,
                                                                        ndarray<std::complex<float>>&,
                                                                        ndarray<std::complex<float>>&,
                                                                        ndarray<std::complex<float>>&, double);
template SparseOperator sparse_operator_hamiltonian<std::complex<double>>(double, ndarray<std::complex<double>>&,
                                                                         ndarray<std::complex<double>>&,
                                                                         ndarray<std::complex<double>>&,
                                                                         ndarray<std::complex<double>>&,
                                                                         ndarray<std::complex<double>>&, double);
