...
class SigmaVectorSparseList : public SigmaVector {
  public:
    ...
    /// h_{pq} = h1[p * nactv + q]
    void add_generalized_sigma_1(const std::vector<double>& h1, psi::std::shared_ptr<psi::Vector> b,
    ...
    void add_generalized_sigma_2(const std::vector<double>& h2, psi::std::shared_ptr<psi::Vector> b,
                                 double factor, std::vector<double>& sigma,
                                 const std::string& spin) override;
    ...
    /// Integrals must be antisymmetric wrt index permutations!
    void add_generalized_sigma_3(const std::vector<double>& h3, psi::std::shared_ptr<psi::Vector> b,
                                 double factor, std::vector<double>& sigma,
                                 const std::string& spin) override;
