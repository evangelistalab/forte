...
void SA_MRDSRG::diis_manager_add_entry() { diis_manager_->add_entry(DT1_, DT2_, T1_, T2_); }

void SA_MRDSRG::diis_manager_extrapolate() { diis_manager_->extrapolate(T1_, T2_); }
