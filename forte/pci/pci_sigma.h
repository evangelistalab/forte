...
class PCISigmaVector : public SigmaVector {
  public:
    ...
    void compute_sigma(psi::std::shared_ptr<psi::Vector> sigma,
                       psi::std::shared_ptr<psi::Vector> b) override;
    ...
    void compute_sigma_with_diag(psi::std::shared_ptr<psi::Vector> sigma,
