...
def dsrg_fno_procrouting(state_weights_map, scf_info, options, ints, mo_space_info,
    ...
    rdms = active_space_solver.compute_average_rdms(state_weights_map, max_rdm_level, forte.RDMsType.spin_free)
    ...
    if not os.path.isfile('NAT_OCC_VIRT'):
        ...
        mrpt2_nos = forte.MRPT2_NOS(rdms, scf_info, options, ints, mo_space_info)
    ...
    options.set_int_list("FROZEN_UOCC", frozen_natural_virtual_occupations(fno_cutoff))
