...
void export_SparseOperator(py::module& m) {
    ...
    m.def("sparse_operator_hamiltonian", &sparse_operator_hamiltonian<float>, "scalar"_a, "oei_a"_a,
          "oei_b"_a, "tei_aa"_a, "tei_ab"_a, "tei_bb"_a, "screen_thresh"_a = 1.0e-12,
          "Create a SparseOperator representing the Hamiltonian from raw integrals");
    m.def("sparse_operator_hamiltonian", &sparse_operator_hamiltonian<double>, "scalar"_a,
          "oei_a"_a, "oei_b"_a, "tei_aa"_a, "tei_ab"_a, "tei_bb"_a, "screen_thresh"_a = 1.0e-12,
          "Create a SparseOperator representing the Hamiltonian from raw integrals");
    m.def("sparse_operator_hamiltonian", &sparse_operator_hamiltonian<std::complex<float>>,
          "scalar"_a, "oei_a"_a, "oei_b"_a, "tei_aa"_a, "tei_ab"_a, "tei_bb"_a,
          "screen_thresh"_a = 1.0e-12,
          "Create a SparseOperator representing the Hamiltonian from raw integrals");
    ...
    m.def(
        ...
        [](std::shared_ptr<ActiveSpaceIntegrals> as_ints, double screen_thresh) {
