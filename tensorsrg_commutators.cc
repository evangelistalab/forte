...
void TensorSRG::commutator_A_B_C_SRC_minus(double factor,
                             BlockedTensor& A1,
                             BlockedTensor& A2,
                             BlockedTensor& B1,
                             BlockedTensor& B2,
...
void TensorSRG::full_commutator_A_B_C(double factor,
                             BlockedTensor& A1,
                             BlockedTensor& A2,
                             BlockedTensor& B1,
                             BlockedTensor& B2,
...
void TensorSRG::full_commutator_A_B_C_SRC(double factor,
                             BlockedTensor& A1,
                             BlockedTensor& A2,
                             BlockedTensor& B1,
                             BlockedTensor& B2,
...
void TensorSRG::full_commutator_A_B_C_SRC_fourth_order(double factor,
                             BlockedTensor& A1,
                             BlockedTensor& A2,
                             BlockedTensor& B1,
                             BlockedTensor& B2,
...
void TensorSRG::full_commutator_A_B_C_SRC_minus(double factor,
                             BlockedTensor& A1,
                             BlockedTensor& A2,
                             BlockedTensor& B1,
                             BlockedTensor& B2,
...
void TensorSRG::full_commutator_A1_B1_C1(BlockedTensor& A,BlockedTensor& B,double alpha,BlockedTensor& C)
{
    boost::timer t;
...
void TensorSRG::full_commutator_A1_B2_C0(BlockedTensor& A,BlockedTensor& B,double alpha,double& C)
{
}

void TensorSRG::full_commutator_A1_B2_C1(BlockedTensor& A,BlockedTensor& B,double alpha,BlockedTensor& C)
{
    boost::timer t;
    C["qp"] += alpha * A["sr"] * B["qrps"];
    C["qp"] += alpha * A["SR"] * B["qRpS"];
...
void TensorSRG::full_commutator_A1_B2_C2(BlockedTensor& A,BlockedTensor& B,double alpha,BlockedTensor& C)
{
    boost::timer t;
...
void TensorSRG::full_commutator_A2_B2_C0(BlockedTensor& A,BlockedTensor& B,double alpha,double& C)
{
    boost::timer t;
...
void TensorSRG::full_commutator_A2_B2_C1(BlockedTensor& A,BlockedTensor& B,double alpha,BlockedTensor& C)
{
    boost::timer t;
...
void TensorSRG::full_commutator_A2_B2_C2(BlockedTensor& A,BlockedTensor& B,double alpha,BlockedTensor& C)
{
    boost::timer t;
