...
def register_embedding_options(forte_options):
    ...
    forte_options.add_bool(
        "EMBEDDING_SEMICANONICALIZE_INACTIVE", True,
        "Perform semi-canonicalization on restricted core/virtual space or not")
    forte_options.add_bool(
...
#                     "Trigger folding T blocks")
    ...
    forte_options.add_bool("DSRG_NO_T2TOT1", False, "Remove the coupling terms in T1 equations")
    forte_options.add_bool("DSRG_NO_FTOT1", False, "Remove the fock terms in T1 equations")
