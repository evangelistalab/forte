...
def register_gas_options(options):
    ...
    options.add_array("GAS1MAX_MULTI","The maximum number of electrons in GAS1 for different root")
    options.add_array("GAS2MAX_MULTI","The maximum number of electrons in GAS2 for different root") 
    options.add_array("GAS3MAX_MULTI","The maximum number of electrons in GAS3 for different root")
    options.add_array("GAS4MAX_MULTI","The maximum number of electrons in GAS4 for different root")
    options.add_array("GAS5MAX_MULTI","The maximum number of electrons in GAS5 for different root")
    options.add_array("GAS6MAX_MULTI","The maximum number of electrons in GAS6 for different root")
    options.add_array("GAS1MIN_MULTI","The minimum number of electrons in GAS1 for different root")
    options.add_array("GAS2MIN_MULTI","The minimum number of electrons in GAS2 for different root")
    options.add_array("GAS3MIN_MULTI","The minimum number of electrons in GAS3 for different root")
    options.add_array("GAS4MIN_MULTI","The minimum number of electrons in GAS4 for different root")
    options.add_array("GAS5MIN_MULTI","The minimum number of electrons in GAS5 for different root")
    options.add_array("GAS6MIN_MULTI","The minimum number of electrons in GAS6 for different root")
